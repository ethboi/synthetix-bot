...
export const alchemyProviderBase = new ethers.providers.JsonRpcProvider(`https://base-mainnet.g.alchemy.com/v2/${ALCHEMY_ID_BASE_OI}`);

export const BASE_NETWORK_CONFIG = {
  name: 'Base',
  shortName: 'Base',
  chainId: 8453,  // Correct chain ID for Base
  network: 'base',
